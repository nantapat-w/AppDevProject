...
const PaymentPage = () => {
    ...
    const fetchAvailableCoupons = async () => {
        try {
            const res = await axios.get('https://appdevproject2.onrender.com/api/coupons', { withCredentials: true });
            if (res.data.success) {
    ...
    const handleApplyCoupon = async (codeOverride) => {
        ...
        try {
            ...
            const res = await axios.post('https://appdevproject2.onrender.com/api/coupons/validate', { code: codeToUse }, { withCredentials: true });
            if (res.data.success) {
    ...
    const fetchAddresses = async () => {
        try {
            ...
            const res = await axios.get('https://appdevproject2.onrender.com/api/account-settings/addresses', { withCredentials: true });
            if (res.data.success) {
    ...
    const handleSaveNewAddress = async (e) => {
        ...
        try {
            setIsLoadingAddress(true);
            const res = await axios.post('https://appdevproject2.onrender.com/api/account-settings/addresses', addressForm, { withCredentials: true });
            if (res.data.success) {
    ...
    const saveOrder = async () => {
        try {
            ...
            const res = await axios.post('https://appdevproject2.onrender.com/api/orders', orderData, { withCredentials: true });
            if (res.data.success) {
